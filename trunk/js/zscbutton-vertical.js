...
* ======================================================================
* ----------------------------------------------------------------------
* zSCbuttonVertical:   Share Counter Buttons - Vertical
* Author:              Zon Saja - http://inimu.com
...
function zscbverSetStyleTextDo(zStyleTextContent,zStyleTextId,zStyleTextMedia) {
	...
	/*if (!!(window.attachEvent && !window.opera)) {
		...
		var zStyleTextContentText = document.createTextNode(zStyleTextContent);
		zStyleTextNode.appendChild(zStyleTextContentText);
	}
...
//zscbverCredNode.style.marginBottom = '0px';
//zscbverCredNode.innerHTML = zscbverCredHTML;
//zscbverNode.appendChild(zscbverCredNode);
